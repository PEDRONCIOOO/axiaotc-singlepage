        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div data-footer="company" className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              />
              <div>
                <h3 className="font-bold text-xl text-slate-800">Axia Digital Solutions</h3>
                <p className="text-sm text-slate-600">Liquidez cripto institucional</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-semibold text-slate-800 mb-3">Contato direto:</h4>
              <a 
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-slate-800">E-mail comercial</div>
                  <div className="text-sm">info@axiadigitalsolutions.com</div>
                </div>
              </a>
            </div>
          </div>
          ...
          <div data-footer="links">
            <h3 className="font-bold text-lg mb-6 text-slate-800">Links Rápidos</h3>
          ...
          <div data-footer="services">
            <h3 className="font-bold text-lg mb-6 text-slate-800">Nossos Serviços</h3>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-600 font-medium">Sistema Online</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-600 font-medium">Segurança SSL</span>
              </div>
            </div>
          </div>
        </div>
